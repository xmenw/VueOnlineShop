        ...
        <div class="nz">
            <div class="nav-center">
                ...
                <div class="show" ref="shopList">
                    <ul>
                        <li v-for="shop in arrSearchShops" :key="shop.id">
                            <div class="item">
...
export default {
    ...
    computed: {
        ...mapState(['arrSearchShops']),
        len(){
            return this.arrSearchShops && this.arrSearchShops.length
        }
    },
    updated(){
        this.$refs.shopList.scrollIntoView()
    },
    created(){
        Object.assign( this.arrSearchShops, JSON.parse(localStorage.getItem('arrSearchShops')))
    },
    methods: {
        select(e){
        ...
        bySales(){
            Object.assign( this.arrSearchShops, this.arrSearchShops.sort((a, b)=>{
