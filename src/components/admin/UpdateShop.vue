    ...
    <div id="updateShop">
        <form ref="form">
            ...
            <div>
                ...
                <input type="text" name="desc" autocomplete="off" v-model="shop.desc">
            </div>
            <div>
                <span class="name">商品颜色：</span>
                <input type="text" name="color" v-model="shop.color">
            </div>
            <div>
                <span class="name">商品尺寸：</span>
                <input type="text" name="size" autocomplete="off" v-model="shop.size">
            </div>
            <div>
                <span class="name">商品价格：</span>
                <input type="text" name="price" autocomplete="off" v-model="shop.price">
            </div>
            <div>
                <span class="name">商品数量：</span>
                <input type="text" name="num" autocomplete="off" v-model="shop.num">
            </div>
            <div class="center">
